Attribute VB_Name = "ShipmentExtractor"
Option Explicit
...
If IsArray(file_name) Then
    For Each f In file_name
        ...
        For Each sht In plan_source.Sheets
            ...
            If Not SHIPMENT_PLAN Is Nothing And Not sht.Name Like "*Copy*" And Not sht.Name Like "*not*ready*" Then
...
'"South Africa", "Urban Drinks", "France", "Norway", "Russia", "Nigeria", "Baltics", "Dublin Airport", "DAA-TBC", "Northern Ireland")
'
...
save_as_path = "F:\Intrepid Spirits\Arnout\Shipment Extractor\BudgetUseShipmentPlan.xlsx"
