Attribute VB_Name = "NewGlobalDepletionAnalyst"
Option Explicit
Sub execute()
Call import_plan
Call process_data
...
'Dim detail_path As String
'detail_path = "F:\Intrepid Spirits\Budget\Budet Restructure\ProductDetailStructure\ProductDetail\"
'product_detail = Dir(detail_path & "*.xls*")
'Do While product_detail <> ""
'    Set detail_wb = Workbooks.Open(detail_path & product_detail)
'    If detail_wb.Name Like "Cost*" Then
'
'    Else
'
'    End If
